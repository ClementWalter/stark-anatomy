...
from hashlib import blake2s, shake_256
...
class RPSSS:
    ...
    def stark_prove(self, input_element, proof_stream):
        ...
        proof = self.stark.prove(
            trace, transition_constraints, boundary_constraints, proof_stream
        )
    ...
    def stark_verify(self, output_element, stark_proof, proof_stream):
        ...
        return self.stark.verify(
            stark_proof, transition_constraints, boundary_constraints, proof_stream
        )
